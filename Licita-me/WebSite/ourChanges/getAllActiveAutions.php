<?php 
    ...
    try {
        ...
        if ($_GET["category"] != "Todas") {
            ...
            $query = "SELECT pecasarte.id, pecasarte.titulo, pecasarte.datafim,  pecasarte.categoria, fotografias.dirimagem, GREATEST(COALESCE(licitacoes.valorlicitacao, pecasarte.valorapreciacaoprecobase),COALESCE(pecasarte.valorapreciacaoprecobase, licitacoes.valorlicitacao)) AS precoAtual
            FROM pecasarte
            INNER JOIN (
