...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject="Peça: {$row['titulo']} - Leilão Terminado Sem Licitações!";
    $mail->Body="O leilão da sua peça terminou sem licitações.<br><br>
    ...
    <span style='color:#029e7c;'>Certificado:</span> Em Anexo<br><br>
