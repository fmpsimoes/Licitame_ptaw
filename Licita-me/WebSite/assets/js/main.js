...
function gerformbody() {
  ...
  forminputcj2.setAttribute("disabled", "disabled")
  forminputcj2.setAttribute("value", precocomprarja() + "€")
  let formbutcj2 = document.createElement("button")
  formbutcj2.setAttribute("type", "submit")
  formbutcj2.setAttribute("class", "eg-btn btn--primary3 btn--sm")
  formbutcj2.setAttribute("value", precocomprarja())
  formbutcj2.innerHTML = "Licitar"
  ...
  forminnercj2.append(formbutcj2)
